...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col py-10 gap-y-5 w-full xl:w-5/6 mx-auto items-center">
      ...
      <div className='flex flex-wrap  items-center
        ...
        <Link href={`/items?q=fragrances`} className='group hover:cursor-pointer flex flex-col gap-y-4 text-center'>
          <img className='max-w-[95vw] mx-auto h-72 aspect-video' src={FraganceImg.src} alt="empty" />
